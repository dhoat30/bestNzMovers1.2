export const servicePropertyMap = {
    Residential: [
        ...
        { value: "2 Man + Truck", label: "2 Man + Truck", price: 0 },
        ...
        { value: "Trade Me Pick & Delivery", label: "Trade Me Pick & Delivery", price: 0 },
        { value: "Long Distance Move", label: "Long Distance Move", price: 0 },
    ],
    Commercial: [
               { value: "Office Move", label: "Office Move", price: 0 },
